...
export default {
  ...
  init: (Core, Tools) => {
    ...
    Core.AttributeManager.createAttribute('style:hover', (element, value) => addClass(element, Core.StyleManager.createHoverStyle(Tools.parseStyleValue(value, this.UnitManager.units))), false)
